...
@flow(persist_result=True, name="km_indicator_absChange_nTemporalItems", flow_run_name=generate_flow_run_name)
def process_flow(
        job_id: str,
        execution_request: schemas.ExecuteRequest
) -> dict:
    return KommonitorProcess.execute_process_flow(KmIndicatorAbsChangeNTemporalItems.run, job_id, execution_request)
