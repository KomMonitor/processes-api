...
class TestRoleInputType(unittest.TestCase):
    """RoleInputType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleInputType:
        """Test RoleInputType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleInputType`
        """
        model = RoleInputType()
        if include_optional:
