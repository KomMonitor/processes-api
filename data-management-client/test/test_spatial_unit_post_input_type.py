...
class TestSpatialUnitPOSTInputType(unittest.TestCase):
    """SpatialUnitPOSTInputType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpatialUnitPOSTInputType:
        """Test SpatialUnitPOSTInputType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpatialUnitPOSTInputType`
        """
        model = SpatialUnitPOSTInputType()
        if include_optional:
            return SpatialUnitPOSTInputType(
                allowed_roles = [
                    ''
                    ],
                geo_json_string = '',
    ...
    def testSpatialUnitPOSTInputType(self):
        """Test SpatialUnitPOSTInputType"""
