...
class TestIndicatorPOSTInputType(unittest.TestCase):
    """IndicatorPOSTInputType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndicatorPOSTInputType:
        """Test IndicatorPOSTInputType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndicatorPOSTInputType`
        """
        model = IndicatorPOSTInputType()
        if include_optional:
            return IndicatorPOSTInputType(
                abbreviation = '',
                allowed_roles = [
                    ''
                    ],
    ...
    def testIndicatorPOSTInputType(self):
        """Test IndicatorPOSTInputType"""
