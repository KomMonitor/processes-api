...
class GeoresourcePOSTInputType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowedRoles", "aoiColor", "datasetName", "geoJsonString", "isAOI", "isLOI", "isPOI", "jsonSchema", "loiColor", "loiDashArrayString", "loiWidth", "metadata", "periodOfValidity", "poiMarkerColor", "poiSymbolBootstrap3Name", "poiSymbolColor", "topicReference"]
