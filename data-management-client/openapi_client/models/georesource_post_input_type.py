...
class GeoresourcePOSTInputType(BaseModel):
    """
    ...
    geo_json_string: Optional[StrictStr] = Field(default=None, description="a valid GeoJSON string containing the features consisting of a geometry and properties specific to the dataset", alias="geoJsonString")
    ...
    __properties: ClassVar[List[str]] = ["permissions", "aoiColor", "datasetName", "geoJsonString", "isAOI", "isLOI", "isPOI", "jsonSchema", "loiColor", "loiDashArrayString", "loiWidth", "metadata", "ownerId", "periodOfValidity", "poiMarkerStyle", "poiMarkerText", "poiMarkerColor", "poiSymbolBootstrap3Name", "poiSymbolColor", "topicReference", "isPublic"]
