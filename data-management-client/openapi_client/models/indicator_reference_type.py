...
class IndicatorReferenceType(BaseModel):
    """
    a reference to another indicator, e.g. a sub-indicator that is used to compute the main indicator
    """ # noqa: E501
    referenced_indicator_description: Optional[StrictStr] = Field(default=None, description="a meaningful description of how the referenced indicator is related to the main indicator", alias="referencedIndicatorDescription")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "referencedIndicatorDescription": obj.get("referencedIndicatorDescription"),
            "referencedIndicatorId": obj.get("referencedIndicatorId"),
            "referencedIndicatorName": obj.get("referencedIndicatorName")
        })
        return _obj
