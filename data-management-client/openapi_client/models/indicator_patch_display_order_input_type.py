...
class IndicatorPATCHDisplayOrderInputType(BaseModel):
    """
    IndicatorPATCHDisplayOrderInputType
    """ # noqa: E501
    display_order: Union[StrictFloat, StrictInt] = Field(description="the new display order value", alias="displayOrder")
    indicator_id: StrictStr = Field(description="unique ID of the associated indicator", alias="indicatorId")
    __properties: ClassVar[List[str]] = ["displayOrder", "indicatorId"]
