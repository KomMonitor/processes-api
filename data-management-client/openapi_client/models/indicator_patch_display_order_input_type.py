...
class IndicatorPATCHDisplayOrderInputType(BaseModel):
    ...
    display_order: Union[StrictFloat, StrictInt] = Field(description="the new displayOrder value", alias="displayOrder")
    __properties: ClassVar[List[str]] = ["indicatorId", "displayOrder"]
