...
class RoleOverviewType(BaseModel):
    """
    RoleOverviewType
    """ # noqa: E501
    role_id: StrictStr = Field(description="the unique role identifier", alias="roleId")
    role_name: StrictStr = Field(description="the role name", alias="roleName")
    __properties: ClassVar[List[str]] = ["roleId", "roleName"]
