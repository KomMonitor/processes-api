...
class GeoresourcePUTInputType(BaseModel):
    """
    GeoresourcePUTInputType
    """ # noqa: E501
    geo_json_string: StrictStr = Field(description="a valid GeoJSON string containing the features consisting of a geometry and properties specific to the dataset", alias="geoJsonString")
