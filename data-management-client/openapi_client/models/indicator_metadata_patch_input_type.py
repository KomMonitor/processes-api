...
class IndicatorMetadataPATCHInputType(BaseModel):
    """
    ...
    creation_type: Optional[CreationTypeEnum] = Field(default=None, alias="creationType")
    dataset_name: Optional[StrictStr] = Field(default=None, description="the meaningful name of the indicator", alias="datasetName")
    ...
    regional_reference_values: Optional[List[RegionalReferenceValueType]] = Field(default=None, description="list of optional regional reference values (i.e. regional sum, average, spatiallyUnassignable)", alias="regionalReferenceValues")
    ...
    refrences_to_other_indicators: Optional[List[IndicatorPOSTInputTypeRefrencesToOtherIndicators]] = Field(default=None, description="array of references to other indicators. E.g., if an indicator is defined by combining four other indicators, then the identifiers of those four indicators can be referenced here", alias="refrencesToOtherIndicators")
    ...
    __properties: ClassVar[List[str]] = ["abbreviation", "characteristicValue", "creationType", "datasetName", "defaultClassificationMapping", "regionalReferenceValues", "displayOrder", "indicatorType", "interpretation", "isHeadlineIndicator", "lowestSpatialUnitForComputation", "metadata", "precision", "processDescription", "referenceDateNote", "refrencesToGeoresources", "refrencesToOtherIndicators", "tags", "topicReference", "unit"]
