...
class ProcessScriptPUTInputType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "name", "requiredGeoresourceIds", "requiredIndicatorIds", "scriptType", "scriptCodeBase64", "variableProcessParameters"]
